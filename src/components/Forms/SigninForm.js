...
import { mindfulness } from '../../assets/images';
...
const Signin = ({ lightbg, alt, imgstart, start }) => {

  const { currentUser } = useUserAuth();
  const navigate = useNavigate();

  const { googleSignIn, facebookSignIn, SignIn, handleSignInChange, signInValues, errorsSignIn, errorsFBPassword, errorsFBEmail, loading } = useForm()
