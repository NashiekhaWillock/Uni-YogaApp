...
bg-purple-900 block md:flex justify-between items-center border-b-2 border-gray-800 p-4 font-semibold text-white 
`

export const NavH1 =  tw.h1`
text-xl text-center md:text-2xl m-auto md:m-0 font-extrabold shadow-lime-600 shadow-md w-full lg:w-1/2
`
